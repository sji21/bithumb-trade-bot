...
| **[검증 기록](docs/research-log.md)** | 왜 그렇게 됐는지 — 10개 계열 579개 조합 검증 결과와 인사이트 |
| **[관찰 프로토콜](docs/rehearsal.md)** | 실주문 전 6개월 리허설 — 무엇을 기록하고 무엇으로 판정하는지 |
| [코드 리뷰](docs/code-review-2026-08-06.md) | 2026-08 리뷰와 검증 에라타 |
...
실주문을 켜기 전 6개월간 신호를 받아보며 규칙을 지킬 수 있는지 확인한다.
